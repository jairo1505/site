...
function galeria(){
	...
	result.innerHTML += "<h1>Galeria:</h1>";
	result.innerHTML += "</div>";
}
function sobre(){
	show();
...
function suporte(){
	...
	result.innerHTML += "<h3>Seu IP:</h3><iframe src=\"site/ip/pop.php\" frameborder=\"0\" scrolling=\"NO\" height=\"130px\" style=\"height: 130px;\" width=\"400px;\"></iframe><br/>";
	result.innerHTML += "<h3>Verifica Porta:</h3><iframe src=\"site/verificaporta/pop.php\" frameborder=\"0\" scrolling=\"NO\" height=\"160px\" style=\"height: 160px;\" width=\"300px;\"></iframe>";
}
var i = 0;
function show(){
